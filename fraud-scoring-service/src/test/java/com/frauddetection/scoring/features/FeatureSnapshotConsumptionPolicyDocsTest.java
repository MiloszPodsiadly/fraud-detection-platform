...
class FeatureSnapshotConsumptionPolicyDocsTest {
    ...
    void documentsCurrentFeatureSnapshotPolicyWithoutStaleHistoricalRuntimeClaims() throws Exception {
        ...
        assertThat(docs)
                ...
                .contains("featureflags` is not consumable by current rules scoring")
                ...
                .contains("must not fall back to retired flags or candidate fields")
                ...
                .contains("must not consume retired policy feature flags")
