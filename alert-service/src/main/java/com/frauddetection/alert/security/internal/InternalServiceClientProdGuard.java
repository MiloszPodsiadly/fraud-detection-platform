...
class InternalServiceClientProdGuard implements InitializingBean {
    ...
    public void afterPropertiesSet() {
        ...
        if ("JWT_SERVICE_IDENTITY".equals(properties.normalizedMode()) && !properties.jwt().complete()) {
            throw new IllegalStateException("JWT_SERVICE_IDENTITY internal auth client mode requires issuer, audience, secret, ttl, and authorities in prod-like profiles.");
        }
