...
class FeedbackDatasetMetricsTest(unittest.TestCase):
    ...
    def test_fixturesUseFeedbackDatasetCompatibleReasonCodes(self):
    ...
    def _metrics(self, *records):
        ...
        return build_feedback_dataset_metrics(dataset)
