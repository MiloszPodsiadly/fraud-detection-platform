...
| --- | --- | --- | --- |
| [Transaction Risk Intelligence UI](transaction_risk_intelligence_ui.md) | FDP-116 read-only frontend panel | Single-transaction Analyst Console display of bounded FDP-115 scored transaction detail diagnostics | Claiming backend/OpenAPI changes, feedback submission, recommendation, case action, scoring mutation, payment authorization, model promotion, threshold recommendation, workflow behavior, or raw payload display |
