...
class EngineIntelligenceApiArchitectureGuardTest {
    ...
    private static final List<String> FDP97_ANALYST_CONSOLE_ENGINE_INTELLIGENCE_ALLOWED_FILES = List.of(
            ...
            "analyst-console-ui/src/components/AnalystRecommendationPanel.jsx",
    ...
    void semanticOwnershipAdrDocumentsCurrentEngineIntelligenceOwnership() throws Exception {
        ...
        assertThat(adr)
                ...
                .contains("VelocitySignalPolicy owns current Velocity v1 semantics.")
                .contains("independent from")
