...
FDP-37 uses Linux CI host networking for Testcontainers dependency access. It does not prove Docker Compose topology parity. A future branch may replace host networking with a shared Testcontainers network and aliases.
