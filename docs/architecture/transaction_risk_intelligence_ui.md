...
section displays status, recommendation value when present, source, confidence, reason codes, warnings, and the
non-decisioning boundary. It uses safe copy for all statuses:
