...
class FraudScoringOrchestratorArchitectureDocsTest {
    ...
    void documentsInternalOrchestrationBoundary() throws Exception {
        ...
        assertThat(docs)
                ...
                .contains("per-engine deadline policy")
                .contains("bounded executor policy")
                .contains("cancellation is cooperative")
                .contains("timeout result means orchestrator stopped waiting")
                .contains("does not guarantee the underlying work was forcibly terminated")
