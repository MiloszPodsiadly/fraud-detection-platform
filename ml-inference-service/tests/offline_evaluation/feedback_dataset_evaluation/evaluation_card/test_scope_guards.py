...
PACKAGE_ROOT = Path(__file__).resolve().parents[4] / "offline_evaluation" / "feedback_dataset_evaluation" / "evaluation_card"
DOC_PATHS = [
...
class FeedbackDatasetEvaluationCardScopeGuardTest(unittest.TestCase):
