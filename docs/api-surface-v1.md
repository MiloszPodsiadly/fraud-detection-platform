...
- The External Head Manifest is an optimization only. It is updated after anchor verification, can be recomputed from anchors, and does not change audit payload or API schemas.
