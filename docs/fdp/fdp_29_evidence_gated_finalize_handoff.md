...
- ADR: `docs/adr/fdp_29_evidence_gated_finalize.md`
- Evidence preconditions: `docs/architecture/evidence_gated_finalize_preconditions.md`
- State machine: `docs/architecture/evidence_gated_finalize_state_machine.md`
- Compatibility matrix: `docs/architecture/evidence_gated_finalize_compatibility_matrix.md`
- API response contract: `docs/api/evidence_gated_finalize_response_contract.md`
- Finalize recovery runbook: `docs/runbooks/regulated_mutation_recovery.md`
- Local audit-chain contention runbook: `docs/runbooks/regulated_mutation_recovery.md`
- Failure windows: `docs/architecture/evidence_gated_finalize_failure_windows.md`
- Idempotency replay: `docs/architecture/evidence_gated_finalize_idempotency_replay.md`
- Migration and rollout: `docs/architecture/evidence_gated_finalize_rollout.md`
- Implementation merge checklist: `docs/fdp/fdp_29_implementation_merge_gate.md`
- Future test plan: `docs/testing/evidence_gated_finalize_test_plan.md`
- Design checklist: `docs/fdp/fdp_29_design_checklist.md`
