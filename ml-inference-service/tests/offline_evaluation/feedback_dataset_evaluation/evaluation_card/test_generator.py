...
class FeedbackDatasetEvaluationCardGeneratorTest(unittest.TestCase):
    def test_generatesEvaluationCardFromValidFdp124Artifacts(self):
        ...
        self.assertEqual("FEEDBACK_DATASET_OFFLINE_EVALUATION_V1", card["evaluationEvidence"]["evaluationReportType"])
...
class fdp124_artifacts:
    ...
    def __enter__(self):
        ...
        reports = build_feedback_dataset_evaluation_reports(dataset, generated_at=GENERATED_AT)
        return write_feedback_dataset_evaluation_reports(reports, output)
