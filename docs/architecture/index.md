...
| --- | --- | --- | --- |
| [Engine intelligence feedback dataset export foundation](engine_intelligence_feedback_dataset_export.md) | FDP-101 internal bounded dataset export foundation | Internal evaluation DTO/JSONL semantics, no-leakage rules, deterministic ordering, duplicate feedback handling, and missing projection semantics | Claiming public API exposure, dashboards, model retraining, model promotion, rule updates, decisioning, submittedBy exposure, or production export readiness |
