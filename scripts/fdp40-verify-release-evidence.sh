...
manifest="${1:-docs/release/fdp_40_release_manifest_template.yaml}"
attestation="${2:-docs/release/fdp_40_attestation_readiness_template.json}"
fdp39="${3:-docs/release/fdp_40_fdp39_provenance_reference.json}"
checks="${4:-docs/release/fdp_40_required_checks_matrix.json}"
...
bank_enabled_false = manifest.get("bank_enabled") == "false"
...
signed_provenance_readiness = manifest.get("signed_provenance_readiness") == "true"
signing_verification_performed = manifest.get("signing_verification_performed") == "true"
signing_enforced_by_fdp40 = manifest.get("signing_enforced_by_fdp40") == "true"
registry_immutability_enforced_by_fdp40 = manifest.get("registry_immutability_enforced_by_fdp40") == "true"
registry_immutability_verified_by_fdp40 = manifest.get("registry_immutability_verified_by_fdp40") == "true"
...
required_checks_defined = manifest.get("required_checks_defined") == "true"
required_checks_platform_enforcement_verified_by_fdp40 = manifest.get("required_checks_platform_enforcement_verified_by_fdp40") == "true"
single_release_owner_model = manifest.get("single_release_owner_model") == "true"
release_owner_required = manifest.get("release_owner_required") == "true"
release_owner_must_be_named = manifest.get("release_owner_must_be_named") == "true"
separate_config_pr_required = manifest.get("separate_config_pr_required") == "true"
...
if not bank_enabled_false:
    failure_reasons.append("bank_enabled_true")
...
if not signed_provenance_readiness:
    failure_reasons.append("signed_provenance_readiness_missing")
if signing_verification_performed:
    failure_reasons.append("signing_verification_unexpected")
if signing_enforced_by_fdp40:
    failure_reasons.append("signing_enforcement_unexpected")
if registry_immutability_enforced_by_fdp40:
    failure_reasons.append("registry_enforcement_unexpected")
if registry_immutability_verified_by_fdp40:
    failure_reasons.append("registry_verification_unexpected")
...
if not required_checks_defined:
    failure_reasons.append("required_checks_not_defined")
if required_checks_platform_enforcement_verified_by_fdp40:
    failure_reasons.append("required_checks_platform_enforcement_unexpected")
if not single_release_owner_model:
    failure_reasons.append("single_release_owner_model_missing")
if not release_owner_required:
    failure_reasons.append("release_owner_not_required")
if not release_owner_must_be_named:
    failure_reasons.append("release_owner_name_not_required")
if not separate_config_pr_required:
    failure_reasons.append("separate_config_pr_not_required")
if not release_config_pr_required:
    failure_reasons.append("release_config_pr_not_required")
if dual_control_required:
    failure_reasons.append("dual_control_must_be_false")
...
data = {
    ...
    "bank_enabled_false": bank_enabled_false,
    "readiness_only": readiness_only,
    "external_platform_controls_required": external_platform_controls_required,
    "signed_provenance_readiness": signed_provenance_readiness,
    "signing_verification_performed": signing_verification_performed,
    "signing_enforced_by_fdp40": signing_enforced_by_fdp40,
    "registry_immutability_enforced_by_fdp40": registry_immutability_enforced_by_fdp40,
    "registry_immutability_verified_by_fdp40": registry_immutability_verified_by_fdp40,
    ...
    "required_checks_defined": required_checks_defined,
    "required_checks_platform_enforcement_verified_by_fdp40": required_checks_platform_enforcement_verified_by_fdp40,
    "single_release_owner_model": single_release_owner_model,
    "release_owner_required": release_owner_required,
    "release_owner_must_be_named": release_owner_must_be_named,
    "separate_config_pr_required": separate_config_pr_required,
