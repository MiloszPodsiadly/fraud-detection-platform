...
public class FraudScoringKafkaConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(
        ...
        errorHandler.setRetryListeners((ConsumerRecord<?, ?> record, Exception exception, int deliveryAttempt) ->
                log.atWarn()
                        .addKeyValue("service", "fraud-scoring-service")
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TransactionEnrichedEvent> transactionEnrichedKafkaListenerContainerFactory(
            ConsumerFactory<String, TransactionEnrichedEvent> transactionEnrichedEventConsumerFactory,
            DefaultErrorHandler kafkaErrorHandler,
            KafkaConsumerProperties kafkaConsumerProperties
    ) {
        ConcurrentKafkaListenerContainerFactory<String, TransactionEnrichedEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(transactionEnrichedEventConsumerFactory);
    ...
    @Bean
    public KafkaAdmin.NewTopics fraudScoringTopics(KafkaTopicProperties kafkaTopicProperties) {
