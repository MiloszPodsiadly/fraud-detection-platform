    ...
    SecurityFilterChain alertSecurityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/audit/degradations/{auditId}/resolve").hasAuthority(AnalystAuthority.AUDIT_VERIFY)
                        .requestMatchers(HttpMethod.GET, "/api/v1/decision-outbox/unknown-confirmations").hasAuthority(AnalystAuthority.AUDIT_VERIFY)
                        .requestMatchers(HttpMethod.POST, "/api/v1/decision-outbox/unknown-confirmations/{alertId}/resolve").hasAuthority(AnalystAuthority.AUDIT_VERIFY)
