    ...
    SecurityFilterChain alertSecurityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/fraud-cases/{caseId}/audit").hasAuthority(AnalystAuthority.FRAUD_CASE_READ)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/fraud-cases/{caseId}/audit").hasAuthority(AnalystAuthority.FRAUD_CASE_READ)
