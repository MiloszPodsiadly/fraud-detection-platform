...
- FDP-50 is now covered by the `FDP-50 API client boundary` section of `Analyst Console Frontend Architecture Gate`, which runs the frontend tests, build, API boundary guard, scope guard, skip/focus guard, and JUnit verification.
