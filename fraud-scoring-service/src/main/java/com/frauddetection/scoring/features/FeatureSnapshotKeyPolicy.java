...
public final class FeatureSnapshotKeyPolicy {
    ...
    private static final Map<String, FeatureSnapshotScalarType> SCALAR_CONSUMABLE_TYPES = Map.ofEntries(
            ...
            Map.entry(FraudFeatureContract.RECENT_TRANSACTION_COUNT_WINDOW, FeatureSnapshotScalarType.STRING),
            Map.entry(FraudFeatureContract.RECENT_AMOUNT_SUM_WINDOW, FeatureSnapshotScalarType.STRING),
            Map.entry(FraudFeatureContract.RAPID_TRANSFER_WINDOW, FeatureSnapshotScalarType.STRING),
            ...
            Map.entry(FraudFeatureContract.RECENT_AMOUNT_SUM, FeatureSnapshotScalarType.DECIMAL),
