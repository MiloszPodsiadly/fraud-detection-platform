...
- Signed anchor metadata is stored with external anchor publication status: `signature_status`, `signature`, `signing_key_id`, `signing_algorithm`, `signed_at`, `signing_authority`, and `signed_payload_hash`.
