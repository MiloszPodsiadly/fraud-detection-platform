...
| `FINALIZING_RETRY_REQUIRES_RECONCILIATION` has operator runbook coverage | `docs/runbooks/regulated_mutation_recovery.md` |
| Local audit-chain contention has operator runbook coverage | `docs/runbooks/regulated_mutation_recovery.md` |
