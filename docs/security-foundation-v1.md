...
| `GET /api/v1/trust/incidents/signals/preview` | `trust-incident:read` | Read-only trust signal preview; no materialization and no mutation audit. |
