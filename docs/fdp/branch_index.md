...
| FDP-42 | Historical fraud case lifecycle | backend / product | Superseded by FDP-81; current runtime keeps regulated PATCH and bounded reads only. | `docs/fdp/fdp_42_summary.md`, `docs/fdp/fdp_42_merge_gate.md`, `docs/product/fraud_case_management.md` | `FDP-42 Fraud Case Management` | Current/removal surface guards, security tests | Historical lifecycle implementation removed |
| FDP-43 | Historical fraud case idempotency | backend / cleanup guard | Local lifecycle idempotency subsystem removed by FDP-81. | `docs/fdp/fdp_43_merge_gate.md`, `docs/runbooks/fraud_case_operations.md` | `FDP-43 Retired Fraud Case Lifecycle Guard` | Deletion guard and regulated update invariant | No local lifecycle retry contract remains |
| FDP-44 | Historical idempotency hardening | backend / cleanup guard | Replay snapshots, retention storage and their emitter were removed by FDP-81. | `docs/fdp/fdp_44_merge_gate.md` | `FDP-44 Retired Fraud Case Lifecycle Guard` | Deletion guard and metrics coverage | Historical dashboard only |
