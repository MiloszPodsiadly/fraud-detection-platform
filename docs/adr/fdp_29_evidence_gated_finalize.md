...
FDP-25/FDP-26/FDP-27/FDP-28 statuses remain valid for legacy commands and replay. FDP-29 maps old command states into the new model without changing legacy meaning. For example:
...
Detailed mapping is defined in `docs/architecture/evidence_gated_finalize_compatibility_matrix.md`.
