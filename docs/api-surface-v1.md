...
| `GET` | `/api/v1/trust/incidents/signals/preview` | Previews current trust signals; requires `trust-incident:read`; does not materialize or audit a mutation. |
