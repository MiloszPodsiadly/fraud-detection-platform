...
| [Transaction Risk Intelligence UI](transaction_risk_intelligence_ui.md) | FDP-116/FDP-118 diagnostics plus FDP-119 read-only recommendation section | Single-transaction Analyst Console display of bounded FDP-115 scored transaction detail diagnostics and FDP-119 advisory analyst recommendation DTO | Claiming backend mutations, feedback submission, case action, scoring mutation, payment authorization, model promotion, threshold recommendation, workflow behavior, apply/accept/reject recommendation behavior, or raw payload display |
