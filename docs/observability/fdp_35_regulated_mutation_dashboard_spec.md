...
idempotencyKey, requestHash, resourceId, exception message, raw path, token, and key material.
...
Use `docs/runbooks/regulated_mutation_drills.md` for operator actions.
