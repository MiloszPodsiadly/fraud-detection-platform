...
- `deployment/local-inputs/shadow-performance/fdp102-feedback-dataset.jsonl`
- `deployment/local-inputs/shadow-performance/model-metadata.json`
...
Demo fixture metrics remain only for the explicit FDP-108 local demo compose override. FDP-109 does not use `deployment/local-fixtures/shadow-performance/current-summary.demo.json` as generation input or fallback.
