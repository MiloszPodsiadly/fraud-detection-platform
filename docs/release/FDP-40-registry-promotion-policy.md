...
- Signing readiness or attestation readiness digest matches release manifest.
...
- Registry immutability is required, but registry immutability is not enforced by FDP-40.
