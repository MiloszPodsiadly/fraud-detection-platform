...
| --- | --- | --- | --- |
| [Analyst Recommendation Backend/API Foundation](analyst_recommendation_backend_api.md) | FDP-119 backend/API foundation | Advisory-only recommendation contract generated by fraud-scoring-service, carried by `TransactionScoredEvent`, stored by alert-service, and exposed on scored transaction detail | Claiming UI rendering, analyst feedback, automatic approve/decline/block, fraud-case creation, payment authorization, scoring mutation, model promotion, threshold recommendation, or final bank decisioning |
